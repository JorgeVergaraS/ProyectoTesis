...
export class IconComponent {
  ...
  readonly paths: Record<string, string> = {
    ...
    monitor:
      'M4 4h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Zm4 18h8m-4-4v4',
    ...
    settings:
      'M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7ZM19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2.12 3.67-.09-.02a1.7 1.7 0 0 0-1.79-.64l-.2.08a1.7 1.7 0 0 0-1.05 1.42V21h-4.24v-.11a1.7 1.7 0 0 0-1.12-1.54l-.2-.08a1.7 1.7 0 0 0-1.87.31l-.06.06-2.12-3.67.08-.07a1.7 1.7 0 0 0 .41-1.84l-.08-.2A1.7 1.7 0 0 0 3.8 12.8H3.7V8.56h.11a1.7 1.7 0 0 0 1.54-1.12l.08-.2a1.7 1.7 0 0 0-.31-1.87l-.06-.06 2.12-3.67.09.02a1.7 1.7 0 0 0 1.79.64l.2-.08A1.7 1.7 0 0 0 10.31.8V.7h4.24v.11a1.7 1.7 0 0 0 1.12 1.54l.2.08a1.7 1.7 0 0 0 1.87-.31l.06-.06 2.12 3.67-.08.07a1.7 1.7 0 0 0-.41 1.84l.08.2a1.7 1.7 0 0 0 1.54 1.05h.11v4.24h-.11A1.7 1.7 0 0 0 19.4 15Z',
    palette:
      'M12 3a9 9 0 0 0 0 18h1.5a1.5 1.5 0 0 0 0-3H12a1.5 1.5 0 0 1 0-3h2.5A6.5 6.5 0 0 0 21 8.5C21 5.5 17 3 12 3ZM7.5 10h.01M10 6.5h.01M15 6.5h.01M17.5 10h.01',
